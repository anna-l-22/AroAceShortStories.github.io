...
export const STORIES: DataStory[] = [
    ...
    },
    {
        ...
        description: "Canon-adjacent story about a man in a city that’s falling apart saving another person from an evil government operation and a serious wound.", series: 2
    },
    {
    ...
    {
        id: 49, title: "Anything Resembling Love", author: 30, warnings: [2], genres: [7], link: "https://reactormag.com/anything-resembling-love-s-qiouyi-lu/", 
    ...
    { 
        ...
        description: "Sequel to The Vampire Conundrum, Rowan deals with a gift exchange and anxiety about the holidays.", intersectionalities: [1,2], genres: [1]
    },
    { 
    ...
    { 
        ...
        description: "Suki left home to escape amatonormativity and goes to a rainy, capitalistic city.", intersectionalities: [2]
    }, //capitalism
    { 
        id: 55, title: "If Absurd Works", author: 6, link: "https://aroworlds.com/2020/08/04/fiction-if-absurd-works/", genres: [1], 
        description: "Suki returns to her amatonormative home to visit her sick mother.",
    ...
    { 
        ...
        description: "A lithromantic girl and her autistic girlfriend have a conversation about their relationship.", warnings: [5,15], genres: [1], intersectionalities: [1,2], 
    ...
    { 
        ...
        description: "A man has doubts the night before his wedding.", genres: [1], series: 4,
    ...
    { 
        ...
        description: "A regretful gay aro man is given the words he need to put his experiences in context.", intersectionalities: [1,2], 
    ...
    { 
        ...
        description: "A witch shopkeeper deals with a fantasy version of Valentine’s Day coming up.", intersectionalities: [2], 
