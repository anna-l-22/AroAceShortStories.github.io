...
export const STORIES: DataStory[] = [
    ...
    { id: 23, title: "The Vampire Conundrum", author: 6, genres: [5], warnings: [12], intersectionalities: [1,2],
        ...
        description: "Rowan brings an aromantic mug to the office, but doesn't know what to do when no one reacts.", source: [3,9]},
    ...
    { id: 51, title: "Monstrous", author: 6, link: "https://aroworlds.com/2019/11/11/hallo-aro-monstrous-k-a-cook/", length: 3, description: "Explores accepting yourself as being aro allo via a metaphor about monsters.",
        warnings: [5], intersectionalities: [], identities: [{sexuality: 5, romantic: 1, explicit: 2, prominance: 1, gender: 5}], genres: [1], source: [9,3]},
    { id: 52, title: "The Pride Conspiracy", author: 6, link: "https://aroworlds.com/2019/12/23/fiction-the-pride-conspiracy-part-one/", source: [3,9], series: 3, warnings: [5,18], 
    ...
    { id: 56, title: "Leaving", author: 6, link: "https://aroworlds.com/2019/01/10/hallo-aro-leaving-k-a-cook/", length: 3, source: [3,4,9], warnings: [5,14],
    ...
    { id: 57, title: "When Quiver Meets Quill", author: 6, link: "https://aroworlds.com/2019/11/13/fiction-when-quiver-meets-quill-part-one/", genres: [1], warnings: [14,15],
        description: "An aromantic shop owner deals with hir coworker trying to set hir up on a date.", intersectionalities: [1,2], source: [3],
    ...
    { id: 58,title: "The Sorcerous Compendium of Postmortem Query", author: 6, link: "https://aroworlds.com/marchverse/mara-and-esher-hill/the-sorcerous-compendium-of-postmortem-query/", genres: [1], intersectionalities: [2],
        series: 4, source: [3], description: "A lithromantic girl seeks advice from the ghosts of members of her community who have died.", warnings: [5,15],
    ...
    { id: 60, title: "Friendship", author: 6, length: 3, link: "https://aroworlds.com/2019/01/08/hallo-aro-friendship-k-a-cook/", source: [3,4], genres: [1], intersectionalities: [],
