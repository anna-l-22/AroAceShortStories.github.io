...
export const STORIES: DataStory[] = [
    ...
    { id: 23, title: "The Vampire Conundrum", author: 6, genres: [5], warnings: [12], intersectionalities: [1,2],
        link: "https://aroworlds.com/2019/11/16/fiction-the-vampire-conundrum-part-one/", series: 3,
        ...
        description: "Rowan brings an aromantic mug to the office, but doesn't know what to do when no one reacts.", source: [3,9,10]},
    ...
    { id: 50, title: "Ode to an Asexual", author: 31, link: "http://strangehorizons.com/poetry/ode-to-an-asexual/", length: 4, genres: [5],
        identities: [{sexuality: 1, romantic: 4, gender: 5, prominance: 1, explicit: 2}], intersectionalities: [], warnings: [1], description: "The narrator discusses their feelings of isolation from asexuality."},
    { id: 51, title: "Monstrous", author: 6, link: "https://aroworlds.com/2019/11/11/hallo-aro-monstrous-k-a-cook/", length: 3, description: "Explores accepting yourself as being aro allo via a metaphor about monsters.",
        warnings: [5], intersectionalities: [], identities: [{sexuality: 5, romantic: 1, explicit: 2, prominance: 1, gender: 5}], genres: [1], source: [9,3,10]},
    { id: 52, title: "The Pride Conspiracy", author: 6, link: "https://aroworlds.com/2019/12/23/fiction-the-pride-conspiracy-part-one/", source: [3,9,10], series: 3, warnings: [5,18], 
        identities: [{sexuality: 6, romantic: 7, gender: 2, explicit: 1, prominance: 1}, {sexuality: 1, romantic: 1, explicit: 1, prominance: 2, gender: 1}, {sexuality: 3, romantic: 9, gender: 2, explicit: 1, prominance: 2}], 
    ...
    { id: 53, title: "Abrasive", author: 6, length: 3, series: 4, link: "https://aroworlds.com/2020/07/07/hallo-aro-abrasive-k-a-cook/", source: [4,3,9], warnings: [5,7,14], genres: [1],
    ...
    { id: 54, title: "The Complexity of Human Decency", author: 6, series: 4, source: [4,9], link: "https://aroworlds.com/2020/07/14/fiction-the-complexity-of-human-decency/", genres: [1], 
        ...
        description: "Suki left home to escape amatonormativity and goes to a rainy, capitalistic city.", intersectionalities: [2]}, //capitalism
    { id: 55, title: "If Absurd Works", author: 6, link: "https://aroworlds.com/2020/08/04/fiction-if-absurd-works/", genres: [1], description: "Suki returns to her amatonormative home to visit her sick mother.",
        warnings: [5,7,19,14], intersectionalities: [2], identities: [{sexuality: 7, romantic: 1, gender: 1, explicit: 2, prominance: 1}], series: 4, source: [4,9]},
    ...
    { id: 61, title: "Attraction", author: 6, length: 3, link: "https://aroworlds.com/2019/02/22/hallo-aro-attraction-k-a-cook/", source: [3,4,10], genres: [1], intersectionalities: [], warnings:[14], series:5,
        identities: [{sexuality: 8, romantic: 1, gender: 1,explicit: 2, prominance: 1}], description: "A sapphic aromantic girl has a conversation with a dragon about the nature of romance and attraction."},
    ...
    { id: 64, title: "Those With More", author: 6, link: "https://aroworlds.com/2020/09/13/book-edition-those-with-more/", length: 2, warnings: [5,14,4,20], series: 4, source: [3,9],
        ...
        {sexuality: 1, romantic: 1, gender: 2, explicit: 1, prominance: 2}], description: 'This is about a guiding priest struggling with the expectations and needs of members of her aromantic community and dealing with the pain of being so old before learning the term “aromantic”.', 
        genres: [1], intersectionalities: [1,2]},
    { id: 65, title: "Lucky", author: 6, link: "https://aroworlds.com/2019/02/20/hallo-aro-lucky-k-a-cook/", length: 3, warnings: [5,14], genres: [5], intersectionalities: [],
    ...
    { id: 66, title: "Love is the Reckoning", author: 6, link: "https://aroworlds.com/2020/09/01/fiction-love-is-the-reckoning/", length: 2, genres: [1], intersectionalities: [1,2], series: 4,
        description: "After a suicide attempt, Esher left his home town to visit a monastery for treatment. Now, Esher returns at his sister’s request.", source: [9], warnings: [4,14,21,22], 
        identities: [{sexuality: 1, romantic: 9, gender: 2, explicit: 1, prominance: 1},{sexuality: 1, romantic: 1, gender: 1, explicit: 1, prominance: 2},{sexuality: 8, romantic: 10, gender: 1, explicit: 1, prominance: 2}]},
    { id: 67, title: "Ringbound", author:6, link: "https://aroworlds.com/marchverse/kit-and-amelia-march/ringbound/", description: "A man has doubts the night before his wedding.", genres: [1], series: 4,
        source: [3,9], warnings: [5,14], intersectionalities: [1,2], identities: [{sexuality: 8, romantic: 1, explicit: 2, gender: 2, prominance: 1}]},
    { id: 68, title: "Absence of Language", author: 6, link: "https://aroworlds.com/marchverse/kit-and-amelia-march/absence-of-language/", series: 4, warnings: [18,9,23,24], 
        description: "A regretful gay aro man is given the words he need to put his experiences in context.", intersectionalities: [1,2], source: [3,9], length: 2, genres: [1],
